...
![Sign In Apple with Javascript](/images/apple.png)
...
- [Sign In with Apple for Angular 8 with a NodeJS server](https://medium.com/shopstyle-engineering/sign-in-with-apple-for-angular-8-and-nodejs-server-f37e6a81545a)
